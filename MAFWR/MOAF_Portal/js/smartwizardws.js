...
$(document).ready(function() {
  ...
  var btnSubmit = $('<button id="submitButton" onclick="submitpage()" style="display:none;margin-left:10px;"></button>').text('Pay & Submit').addClass('btn btn-ws').on('click', function() {
    $('#loader').show();
    $('#loader-wrapper').show();
  });
  var btnBank = $('<button id="bankButton" onclick="submitpage()" style="display:none;margin-left:10px;"></button>').text('Submit Bank Guarantee').addClass('btn btn-ws').on('click', function() {
    $('#loader').show();
    $('#loader-wrapper').show();
  });
  // Smart Wizard
  $('#smartwizard').smartWizard({
    ...
    toolbarSettings: {
      ...
      toolbarExtraButtons: [btnFinish, btnSubmit, btnBank]
    },
...
/*$('.input-cart-number').on('keyup change', function() {
  ...
  card_number = card_number.slice(0, -1);
  $('#Invnumber').val(card_number);
});*/

$('#Invnumber').on('keyup', function() {
  var card_number = '';
