//Catchment Button
 function Catchment_fn() {
    if ($("#Catchmentid").text() == "تحديث") {
        Catchmentedit.remove().draw();
        $("#Catchmentid").text("اضافة");
    } else {}
 ...
 $(document).ready(function() {
    ...
    { "mDataProp": "regionCat", sTitle: "المحافظة", sType: "string" }, 
    { "mDataProp": "WillayatCat", sTitle: "الولاية", sType: "string" }, 
    { "mDataProp": "CatchmentCat", sTitle: "المستجمع المائي", sType: "string" }, 
    { "mDataProp": "EastingsCat", sTitle: "شرقي", sType: "string" }, 
    { "mDataProp": "NorthingsCat", sTitle: "شمالي", sType: "string" }, 
    { "mDataProp": "Actions", sTitle: "الإجراء", sType: "string", "defaultContent": "<a id = 'editCatchdetails' href='javascript:void(0)' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removeCatchdetails' href='javascript:void(0)' class='text-red'><i class='fa fa-trash-o'></i></a>" }
    ];
    var table = $('#Catchment_table').DataTable({
...
//labor Button
 ...
 $(document).ready(function() {
    ...
    var labor_cols = [
    { 'mDataProp': 'msno', sTitle: 'الرقم المتسلسل', sType: 'string', 'defaultContent' : 'text' },
    { 'mDataProp': 'LaborProf', sTitle: 'مهنة العامل', sType: 'string' },
    { 'mDataProp': 'labor_No', sTitle: 'عدد العمال المطلوبين', sType: 'string' },
    { 'mDataProp': 'Actions', sTitle: 'الإجراء', sType: 'string', 'defaultContent': "<a id = 'editlabordetails' href='javascript:void(0)' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removelabordetails' href='javascript:void(0)' class='text-red'><i class='fa fa-trash-o'></i></a>" }
    ];
    var table = $('#labor_table').DataTable({
 ...
 $(document).ready(function() {
    ...
    var Equi_cols = [
    { 'mDataProp': 'msno', sTitle: 'الرقم المتسلسل', sType: 'string', 'defaultContent' : 'text' }, 
    { 'mDataProp': 'TypeEqu', sTitle: 'نوع المعدة', sType: 'string' }, 
    { 'mDataProp': 'NameEquipment', sTitle: 'اسم المعدة', sType: 'string' },
    { 'mDataProp': 'CR_NO', sTitle: 'الاسم التجاري', sType: 'string' },
    { 'mDataProp': 'EquiEngine', sTitle: 'رقم المحرك', sType: 'string' },
    { 'mDataProp': 'EquiManuf', sTitle: 'سنة الصنع', sType: 'string' },
    { 'mDataProp': 'EquiCountry', sTitle: 'بلد الصنع', sType: 'string' },
    { 'mDataProp': 'Equisr_no', sTitle: 'الرقم التسلسلي', sType: 'string' },
    { 'mDataProp': 'IssuingDate', sTitle: 'تاريخ الاصدار', sType: 'string' }, 
    { 'mDataProp': 'ExpiryDate', sTitle: 'تاريخ الإنتهاء', sType: 'string' },
    { 'mDataProp': 'EquiColor', sTitle: 'اللون', sType: 'string' },
    { 'mDataProp': 'Actions', sTitle: 'الإجراء', sType: 'string', 'defaultContent': "<a id = 'editEquidetails' href='javascript:void(0)' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removeEquidetails' href='javascript:void(0)' class='text-red'><i class='fa fa-trash-o'></i></a>" }
    ];
    var table = $('#Equi_table').DataTable({
        'aoColumns': Equi_cols,
        'columnDefs': [{
